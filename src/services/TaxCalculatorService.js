...
export const descontoPadraoRt = 528.00;
...
export const calcularProLabore = (salarioPj) => (salarioPj * fatorR <= salarioMinimo) ? salarioMinimo : salarioPj * fatorR;
...
export const calcularIrrfPj = (salario, inss) => {
  ...
  let resultado = 0;
  resultado = (irrfBaseCalculo <= IrrfFaixa1Teto)
...
export const SalarioMinimo = 1320.00;
export const FatorR = 28 / 100;
export const InssPatronalAliquota = 11 / 100;
export const InssPatronalPisoContribuicao = 145.20;
export const DescontoPadraoRt = 528.00;
...
export const calcularInss = (proLaborePj) => (proLaborePj * InssPatronalAliquota > InssTetoContribuicao) ? InssTetoContribuicao : proLaborePj * InssPatronalAliquota;