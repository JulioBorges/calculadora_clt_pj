      ...
      >
        <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <Typography gutterBottom variant="h7" component="h4">
            <span style={colorBlue}>{formatCurrency(salaryDiff.pjSalary)} [{formatPercent(salaryDiff.percent)}]</span>
          </Typography>
          ...
          <Typography gutterBottom align='center' fontSize='medium'>
            <strong style={colorRed}>{formatCurrency(salaryDiff.tax.totalTax)} [{formatPercent(salaryDiff.tax.percent)}]</strong>          
          </Typography>
